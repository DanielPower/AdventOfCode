...
fn main() {
    ...
    for intersection in intersections {
        let value: i32 = intersection.x.abs() + intersection.y.abs();
        if value < min {
            min = value;
        }
    }
